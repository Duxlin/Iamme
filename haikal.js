...
//=================================================//
case 'textmaker':
if (isBan) return m.reply('You are banned by the owner, you dont have to pretend')
await loading()
...
if (ceknye.length == 0) return m.reply(`not om WhatsApp!!!`)
owner.push(bnnd)
...
if (m.quoted || text) {
if (froms.startsWith('08')) return reply('Awali nomor dengan +234')
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY DUX BOTWA MODS`);
});
}
